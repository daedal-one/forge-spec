...
spec impact REQ:auth/foo#c-id  # durable cascade plus separate related work/docs/source/history
...
spec inspect graph work        # explicit TASK addressing/blocking graph
spec task address TASK:auth/foo REQ:auth/bar#c-id
...
| Lint rules R001-R032 | 614-658 | 9 |
